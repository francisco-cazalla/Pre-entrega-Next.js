function ContactoPage(){
    return (
        <div className="grid  grid-cols-1  px-8 py-28 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-100 dark:text-gray-800">
	...
	<form noValidate="" className="space-y-6">
		...
		<button type="submit" className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded dark:bg-red-600 dark:text-gray-50">Send Message</button>
	</form>
</div>
    )
}
